  ...
  rules: [
    {
      ...
      message: t('tools.roman-numeral-converter.invalidArabic', {
...
const { copy: copyRoman } = useCopy({ source: outputRoman, text: t('tools.roman-numeral-converter.copiedRoman') });
const { copy: copyArabic } = useCopy({ source: () => String(outputNumeral.value), text: t('tools.roman-numeral-converter.copiedArabic') });
</script>
