...
<template>
  <div>
    ...
    <div v-if="notComposable.length > 0">
      <n-alert :title="t('tools.docker-run-to-docker-compose-converter.notTranslatable')" type="info" mt-5>
        <ul>
    ...
    <div v-if="notImplemented.length > 0">
      <n-alert :title="t('tools.docker-run-to-docker-compose-converter.notImplemented')" type="warning" mt-5>
        <ul>
