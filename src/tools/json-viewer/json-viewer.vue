...
const rawJson = useStorage('json-prettify:raw-json', (route.query.input as string) || '{"hello": "world", "foo": "bar"}');
if (route.query.input) {
  rawJson.value = route.query.input as string;
}
  ...
  rules: [
    {
      ...
      message: t('tools.json-viewer.invalidJson'),
    },
  ],
});
</script>
